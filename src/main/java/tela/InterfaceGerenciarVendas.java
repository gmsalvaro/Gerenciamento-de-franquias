...
public class InterfaceGerenciarVendas extends JFrame {
    ...
    // Map auxiliar para acesso rápido a produtos pelo ID
    ...
    private void initComponents() {
        ...
        // --- PAINEL DE PRODUTOS DISPONÍVEIS (ESQUERDA) ---
        ...
        // --- PAINEL DO CARRINHO DE COMPRAS (DIREITA) ---
        ...
        // --- PAINEL DE BOTÕES FINAIS (INFERIOR) ---
        ...
        // --- MONTAGEM PRINCIPAL COM SPLITPANE ---
    ...
    private void carregarProdutos() {
        ...
        try {
            ...
            for (Produto p : produtos) {
                ...
                produtosDisponiveisMap.put(p.getId(), p); // Usaremos o ID como chave no mapa
            }
    ...
    private void acaoAdicionarCarrinho() {
        ...
        // Encontra o ID do produto pelo nome (mais frágil, o ideal seria ter o ID na tabela)
        ...
        if(produtoSelecionado == null) return; // Não deveria acontecer
    ...
    private void acaoRemoverCarrinho() {
        ...
        // Encontra o ID pelo nome para remover do mapa
    ...
    private void acaoFinalizarCompra() {
        ...
        if (confirm == JOptionPane.YES_OPTION) {
            try {
                ...
                // Passa o vendedor logado e a forma de pagamento para o serviço
